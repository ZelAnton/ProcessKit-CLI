#!/usr/bin/env bash
#
# Checks this machine can build and test ProcessKit-CLI (POSIX counterpart of check-env.ps1 — use whichever matches your
...
if [ ${#problems[@]} -eq 0 ]; then
  echo
  echo "Environment ready. Next: just test"
