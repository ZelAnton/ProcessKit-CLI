...
<#
.SYNOPSIS
    Checks this machine can build and test ProcessKit-CLI.
...
.DESCRIPTION
    ...
    Run it before local development commands:
...
if ($problems.Count -eq 0) {
    Write-Host ""
    Write-Host "Environment ready. Next: just test" -ForegroundColor Green
